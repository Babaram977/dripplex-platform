...
// DPX-MOBILE-003 — moved to ./presenceStatus so the rider screen can use it
// too. driverScreen already imports LOCATION_PUSH_INTERVAL_MS from riderScreen,
// so importing this the other way would have closed a module cycle: legal in ES
// modules, but it makes initialisation order decide whether a const is defined,
// and that is not a thing to leave for someone to discover at runtime.
export { DriverPresenceStatus } from './presenceStatus';
  ...
  return (
    ...
    >
      ...
      <div className="flex-1 overflow-y-auto px-5 pb-4">
        ...
        <StandingReferralCard loadStats={api.driverReferrals.stats} />
        <DriverReferralCard />
