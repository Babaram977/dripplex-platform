...
/** DPX-CORE-001 — first real consumer of the notification-center SDK client
 * (backend/SDK/types have existed since before this pass, unconsumed by any
 * UI in any app). Replaces the previously decorative Bell button. */
