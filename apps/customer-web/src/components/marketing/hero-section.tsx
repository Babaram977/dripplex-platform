...
export function HeroSection(): React.JSX.Element {
  return (
    <section className="relative isolate min-h-[100dvh] overflow-hidden">
      ...
      <div
        aria-hidden="true"
        className="bg-[url('data:image/svg+xml,%3Csvg xmlns=%27http://www.w3.org/2000/svg%27 viewBox=%270 0 800 900%27%3E%3Cdefs%3E%3ClinearGradient id=%27g%27 x1=%270%27 y1=%270%27 x2=%271%27 y2=%271%27%3E%3Cstop stop-color=%27%230E7A3E%27/%3E%3Cstop offset=%271%27 stop-color=%27%23FFC107%27 stop-opacity=%270.75%27/%3E%3C/linearGradient%3E%3C/defs%3E%3Crect width=%27800%27 height=%27900%27 fill=%27url(%23g)%27/%3E%3Ccircle cx=%27580%27 cy=%22220%27 r=%22160%27 fill=%27%23fff%27 fill-opacity=%270.08%27/%3E%3Ccircle cx=%22220%27 cy=%22680%27 r=%22200%27 fill=%27%230A2540%27 fill-opacity=%270.18%27/%3E%3Cpath d=%27M0 620 C180 540 320 740 520 660 C680 600 760 700 800 640 L800 900 L0 900 Z%27 fill=%27%23fff%27 fill-opacity=%270.1%27/%3E%3C/svg%3E')] absolute inset-y-0 right-0 -z-10 hidden w-[52%] bg-cover bg-center lg:block"
      />
