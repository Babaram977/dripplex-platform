...
export NEXT_PUBLIC_APP_URL="${NEXT_PUBLIC_APP_URL:-https://ops.dripplex.com}"
export NEXT_PUBLIC_SENTRY_DSN="${NEXT_PUBLIC_SENTRY_DSN:-}"

echo "cf-build (operations-console): NEXT_PUBLIC_API_BASE_URL=${NEXT_PUBLIC_API_BASE_URL}"
echo "cf-build (operations-console): NEXT_PUBLIC_APP_URL=${NEXT_PUBLIC_APP_URL}"
echo "cf-build (operations-console): NEXT_PUBLIC_SENTRY_DSN=${NEXT_PUBLIC_SENTRY_DSN:+set}"
