...
/**
 * DPX-STORAGE-001 (F) — TTL for signed GET URLs used to retrieve private
 * documents (KYC/identity). Short enough that a leaked URL expires quickly, long
 * enough for a reviewer to open the document. 5 minutes, same as the PUT TTL.
 */
