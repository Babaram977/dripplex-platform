...
/** PAYSTACK | FLUTTERWAVE | OPAY — same gateway set as order/ride card
 * payments. Moniepoint is not a real gateway partner for this platform. */
export type WalletFundingProvider = 'PAYSTACK' | 'FLUTTERWAVE' | 'OPAY';
