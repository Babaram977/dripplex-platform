...
## Flagged for founder confirmation — not yet built either way

| Figma                                                                                                                                      | Backend                                                                                                                         | Status                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
| ------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `DriverSplashScreen` / `DriverLoginScreen` / `DriverOTPScreen` — 3 screens, App.tsx routes `Home → drvsplash → drvlogin → drvotp → drvkyc` | The account is already authenticated in the Super App (same JWT session) — a second phone+OTP login has no backend purpose here | **Not built, and flagged rather than silently decided.** These 3 screens were skipped when building the Driver Registration flow, reasoning that a logged-in Super App user shouldn't be asked to log in again. That is a judgment call, not a pure connect-or-document case — it changes what the user sees vs. what Figma specifies. Founder decision needed: (a) confirm skipping is correct and this entry just documents it, or (b) require the 3 screens be built anyway (e.g. as a pass-through/confirmation step) to match Figma exactly, per the "build N screens if Figma has N screens" rule. |
