...
| KYC / Identity Verification | ✅ (Figma only) | 🚧 In progress | ⏳ Not started | **Decided 2026-08-07** — tiered (Level 0/1/2), 7-state lifecycle. Schema (`CustomerKyc`) built; service/controller/UI not yet. See `docs/DPX-PROFILE-KYC-001-DESIGN.md`.                                                                                                |
